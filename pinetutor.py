...
def generate_llama2_response(prompt_input):
    string_dialogue = "You are a pinecone Tutor.You have to stricly frame a short and precise response out of the prompt_input only.Do not use your data or knowledge to answer if the input_prompt exist.If the prompt_input doesnt exist be polite and helpful to reply"
    ...
    with st.chat_message("assistant"):
        with st.spinner("Thinking..."):
            ...
            if(res_context=="") :
              ...
              response = generate_llama2_response(res_context)
